...
const AdminHome = () => {
  ...
  const pendingApprovals = [
    {
      title: "Science Weekly Podcast",
      submitter: "Robert Chen",
      submitted: "2 days ago",
      type: "New Podcast",
    },
    {
      title: "Health & Wellness Special",
      submitter: "Lisa Wong",
              ...
              <div key={index} className={styles.approvalItem}>
                <div className={styles.approvalInfo}>
                  ...
                  <div className={styles.approvalMeta}>
                    Submitted by {approval.submitter} • {approval.submitted} •{" "}
                    {approval.type}
                  </div>
                </div>
