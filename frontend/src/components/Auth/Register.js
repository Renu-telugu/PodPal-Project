...
const Register = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      // Success message (the redirect will be handled by the useEffect)
        ...
        <form className={styles.authForm} onSubmit={handleSubmit}>
          ...
          <div className={styles.roleSelection}>
            ...
            <div className={styles.roleCards}>
              <div 
                className={`${styles.roleCard} ${selectedRole === 'user' ? styles.roleCardSelected : ''}`}
                onClick={() => handleRoleSelect('user')}
              >
                <FontAwesomeIcon icon={faHeadphones} className={styles.roleIcon} />
                <div>
                  <h4 className={styles.roleTitle}>Listener</h4>
                  <p className={styles.roleDescription}>Discover and enjoy podcasts</p>
                </div>
              </div>
              
              <div 
                className={`${styles.roleCard} ${selectedRole === 'admin' ? styles.roleCardSelected : ''}`}
                onClick={() => handleRoleSelect('admin')}
              >
                <FontAwesomeIcon icon={faUserShield} className={styles.roleIcon} />
                <div>
                  <h4 className={styles.roleTitle}>Admin</h4>
                  <p className={styles.roleDescription}>Manage content and users</p>
                </div>
              </div>
            </div>
          </div>
